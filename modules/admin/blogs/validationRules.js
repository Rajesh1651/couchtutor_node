...
validationObject = {
	...
	validateForBlog : [
		check('title',				anyObjectForLocale.__("ADMIN.BLOG.PLEASE_ENTER_PAGE_TITLE_HERE")).trim().notEmpty(),		
		check('decription',			anyObjectForLocale.__("ADMIN.BLOG.PLEASE_ENTER_DESCRIPTION_HERE")).trim().notEmpty(),
